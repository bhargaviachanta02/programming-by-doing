...
public class Java105
{
	public static void main( String[] args )
	{
		  ...
		  System.out.println(b());    // returns the word to be displayed
		  ...
		  System.out.println(g());     // returns the word to be displayed
		  h( 1 );    // tell it how many times to display the word (1)
		  System.out.println();
 
		 i( 2 );    // pass it any integer and it will display a word beginning with I 
		 System.out.println(j(3));    // returns a different word depending on what you pass it (1-3)
		 ...
		 n( "Not" );    // displays the word you pass it beginning with "N"
		 o();    // displays a word beginning with O and returns a useless value
		 System.out.println(p()); // returns the word to be displayed
		 q();    // displays the word
		System.out.println();

		 System.out.println(r(true));    // returns a different word depending on if you pass it 'true' or 'false'
		 s( 6 );    // pass it the number of letters to display (6)
		 t( "T" );    // displays the word you pass it beginning with "T"
		 System.out.println(u());   // returns the word to be displayed
		 v(1);    // tell it how many times to display the word (1)
		 w(5);    // pass it any integer and it will display a word beginning with W 
		 System.out.println(x(1));    // returns a different word depending on what you pass it (1-2)
		 y( );    // displays a word beginning with Y
		 System.out.println(z( false,false));    // returns a different word depending on which two boolean values you pass it
		System.out.println();
	}
