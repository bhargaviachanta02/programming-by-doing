...
public class Java56 {
	...
	//public class DoWhileSwimming
		...
		public static void main( String[] args ) throws Exception
		{
			...
			double minimumTemperature = 79.0; // degrees Fahrenheit// if 80.5 each swimmer takes 2 min of time 
			...
			{
				System.out.print( "\t" + swimmer1 + " swims for a bit." );//gallant check water temp before dive
				swimTime++;
				System.out.println( " Swim time: " + swimTime + " min." );
				Thread.sleep(900); // pauses for 600 milliseconds
				currentTemperature -= 1.0; // subtracts 1/2 a degree from the water temperature
			...
			swimTime = 0;
			do//post test loop // gooofus first dive and later check it 
			{
